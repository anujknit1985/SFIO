...
@Data
@Entity
@Table(name="DSCSigningDeatils",schema = "public")
public class DSCSigning
{
    ...
    public DSCSigning(String serialNo, String issuedTo, String issuedBy, Date validity, String status,
