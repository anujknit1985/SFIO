...
@Data
@Entity
@Table(name="NoticeDSCSigningDeatils",schema = "public")
public class NoticeDSCSigning {
    ...
    public NoticeDSCSigning(String serialNo, String issuedTo, String issuedBy, Date validity, String status,
